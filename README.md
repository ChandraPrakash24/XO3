...
Project: [https://github.com/ChandraPrakash24/XO3.git](https://github.com/ChandraPrakash24/XO3.git)
...
3. Run `npm run dev` or `yarn start dev` to get the project started.
